/** Heykal Security — content module. Replace placeholders with verified facts only. */

export const heykal = {
  name: "Heykal Security",
  tagline: "Elite physical security & surveillance",
  wordmark: "HEYKAL",
  hotline: "+1 (800) 555-0199",
  hotlineTel: "tel:+18005550199",
  email: "operations@heykalsecurity.com",
  ...
  testimonials: [
    {
      quote:
        "Heykal’s team became part of our building’s rhythm—firm at access points, invisible everywhere else. Our board noticed the difference in week one.",
    ...
    {
      quote:
        "Event nights are unpredictable. Heykal’s command post coordination with local teams was textbook—no drama, just control.",
      name: "Head of Events",
